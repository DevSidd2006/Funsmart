      ...
      <div className="container-fluid relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[0.9fr_1.1fr] gap-12 lg:gap-20 items-start">
            ...
            >
              ...
              <div className="relative mb-10">
                ...
                <div className="absolute -bottom-6 -right-6 bg-[#1E2A44] text-white px-8 py-6 rounded-2xl shadow-xl hidden md:block">
                  <span className="text-accent-teal text-xs font-bold uppercase tracking-widest block mb-1">Founder's Origin</span>
                  <span className="text-xl font-serif font-bold italic opacity-90">"Thinking over Rote"</span>
                </div>
              </div>

              {/* Bio Details */}
              <div className="pl-4 border-l-2 border-accent-teal/20">
                ...
                <div className="space-y-5 text-neutral-600 leading-relaxed text-lg italic">
                  ...
                  <p>
                    <span className="text-primary-500 font-bold not-italic">What stood out was simple:</span> the right environment can completely change how a child observes, persists, and solves.
                  </p>
                  <p>
            ...
            >
              <div className="mb-10">
                <span className="inline-block px-4 py-1.5 bg-blue-50 text-primary-400 rounded-full text-xs font-bold uppercase tracking-widest mb-6">
                  Our Philosophy
                </span>
