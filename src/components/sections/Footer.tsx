        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16 mb-20">
          <div className="md:col-span-5">
            ...
            <p className="text-neutral-500 max-w-sm leading-relaxed mb-10">
              A premium laboratory for parents who value intelligence over marks. Helping children aged 8-14 discover their thinking patterns.
            </p>
            <div className="flex gap-4">
               {['FB', 'IG', 'LI', 'YT'].map(social => (
                 <a key={social} href="#" className="w-10 h-10 rounded-sm border border-neutral-200 flex items-center justify-center text-mono text-[10px] text-neutral-400 hover:border-primary-500 hover:text-primary-500 transition-all">{social}</a>
               ))}
            </div>
          </div>
          ...
          <div className="md:col-span-4">
            ...
            <div className="space-y-4 text-sm text-neutral-500 leading-relaxed">
              <p>Baner - Balewadi Road, Pune, Maharashtra 411045</p>
              <p>+91 99999 99999 <br /> hello@funsmartism.in</p>
              <p className="pt-4 text-mono text-accent-teal uppercase tracking-widest text-[10px]">Open: Tue - Sun | 10:00 AM - 7:00 PM</p>
            </div>
          </div>
        </div>

        <div className="pt-12 border-t border-neutral-100 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-xs text-neutral-400 font-mono tracking-tighter">© 2026 FUNSMARTISM_INTELLIGENCE_CENTER</p>
