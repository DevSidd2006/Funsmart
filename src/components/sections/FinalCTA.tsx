    ...
    <section className="py-24 md:py-36 bg-gradient-to-br from-[#1E2A44] via-[#1a3a4a] to-[#1E2A44] text-white relative overflow-hidden">
      ...
      <div className="container-fluid relative z-10 text-center">
        <div className="max-w-3xl mx-auto">
          <div className="text-mono text-[#2FB5A3] mb-8 uppercase tracking-widest">[ TAKE_THE_NEXT_STEP ]</div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2.5 px-10 py-4 text-base font-semibold rounded-lg border border-white/20 text-white hover:bg-white/10 hover:border-white/40 transition-all duration-300 w-full sm:w-auto"
            >
